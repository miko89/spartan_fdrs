...
with open('visibility_wioo.txt', 'wb') as f:
    c = pycurl.Curl()
    c.setopt(c.URL, 'http://aviation.bmkg.go.id/latest/metar.php?m=8&y=2021&i=wioo')
...
with open('visibility_wagg.txt', 'wb') as f:
    c = pycurl.Curl()
    c.setopt(c.URL, 'http://aviation.bmkg.go.id/latest/metar.php?m=8&y=2021&i=wagg')
    c.setopt(c.WRITEDATA, f)
    c.perform()
    c.close()
...
with open('visibility_wijj.txt', 'wb') as f:
    c = pycurl.Curl()
    c.setopt(c.URL, 'http://aviation.bmkg.go.id/latest/metar.php?m=8&y=2021&i=wijj')
    c.setopt(c.WRITEDATA, f)
    c.perform()
    c.close()
...
with open('visibility_wibb.txt', 'wb') as f:
    c = pycurl.Curl()
    c.setopt(c.URL, 'http://aviation.bmkg.go.id/latest/metar.php?m=8&y=2021&i=wibb')
    c.setopt(c.WRITEDATA, f)
    c.perform()
    c.close()
...
with open('visibility_wipp.txt', 'wb') as f:
    c = pycurl.Curl()
    c.setopt(c.URL, 'http://aviation.bmkg.go.id/latest/metar.php?m=8&y=2021&i=wipp')
    c.setopt(c.WRITEDATA, f)
    c.perform()
    c.close()
